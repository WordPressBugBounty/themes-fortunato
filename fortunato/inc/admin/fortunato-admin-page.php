		...
		<div class="cresta-theme-info">
			...
			<div class="welcome-description-wrap">
				...
				<p class="cresta-actions">
					...
					<a href="<?php echo esc_url( apply_filters( 'fortunato_pro_theme_url', 'https://crestaproject.com/demo/fortunato/' ) ); ?>" class="button button-secondary docs" target="_blank"><?php esc_html_e( 'View Demo', 'fortunato' ); ?></a>

					<a href="<?php echo esc_url( apply_filters( 'fortunato_pro_theme_url', 'https://crestaproject.com/demo/fortunato-pro/' ) ); ?>" class="button button-primary docs" target="_blank"><?php esc_html_e( 'View PRO version Demo', 'fortunato' ); ?></a>
				...
				<tbody>
					...
					<tr>
						...
						<td class="btn-wrapper">
							...
							<a href="<?php echo esc_url( apply_filters( 'fortunato_pro_theme_url', 'https://crestaproject.com/downloads/fortunato/' ) ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'More Information', 'fortunato' ); ?></a>
						</td>
					</tr>
				</tbody>
			</table>
