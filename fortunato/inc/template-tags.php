...
function fortunato_posted_on() {
	...
	echo '<span class="posted-on"><i class="far fa-clock spaceRight" aria-hidden="true"></i>' . $time_string . '</span><span class="byline"><i class="far fa-user spaceLeftRight" aria-hidden="true"></i>' . $byline . '</span>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
