...
function fortunato_scripts() {
	...
	wp_enqueue_style( 'font-awesome-5', get_template_directory_uri() .'/css/all.min.css', array(), '5.15.4');
	...
	$googleFontsLocal = get_theme_mod('fortunato_theme_options_googlefontslocal', '');
	if ($googleFontsLocal == 1) {
		require_once get_theme_file_path( 'inc/wptt-webfont-loader.php' );
		wp_enqueue_style( 'fortunato-googlefonts', wptt_get_webfont_url(add_query_arg( $query_args, 'https://fonts.googleapis.com/css2' ) ), array(), null );
	} else {
		wp_enqueue_style( 'fortunato-googlefonts', add_query_arg( $query_args, "//fonts.googleapis.com/css2" ), array(), null );
	}
